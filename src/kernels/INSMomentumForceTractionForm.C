...
INSMomentumForceTractionForm::INSMomentumForceTractionForm(const InputParameters & parameters) :
    INSMomentumBaseForce(parameters)
{
}

Real
INSMomentumForceTractionForm::computeQpResidualViscousPart()
{
...
Real
INSMomentumForceTractionForm::computeQpJacobianViscousPart()
{
...
Real
INSMomentumForceTractionForm::computeQpOffDiagJacobianViscousPart(unsigned jvar)
{
