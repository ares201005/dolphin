...
[Preconditioning]
  ...
  [./myPBP]
    type = PBP
    solve_order = 'potential conA conC u v p'
    preconditioner  = 'AMG AMG AMG AMG AMG AMG'
    off_diag_row = 'potential conA conC u v p'
    off_diag_column = 'potential conA conC u v p'
  [../]
[]
...
[Kernels]
  ...
  # x-momentum, space
  [./x_momentum_space]
    type = INSMomentumForceLaplaceFormRZ
    variable = u
    u = u
    v = v
    p = p
